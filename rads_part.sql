...
ALTER TABLE Send_Slicker ADD CONSTRAINT fk_sticker_id FOREIGN KEY (sticker_id) REFERENCES Sticker(sticker_id);
ALTER TABLE Has_Slicker_Pack ADD CONSTRAINT fk_sticker_pack_id FOREIGN KEY (sticker_pack_id) REFERENCES Sticker_Pack(sticker_pack_id);
